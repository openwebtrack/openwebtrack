...
<div class="flex h-[500px] flex-col overflow-hidden rounded-2xl border border-border bg-card">
	...
	<div class="flex-1 p-4">
		...
		<div class="mb-2 flex items-center px-2">
			...
			<div class="hidden w-40 justify-end sm:flex">
				<Skeleton class="h-4 w-16" />
			</div>
		</div>
		...
		<div class="flex flex-col gap-1">
			{#each Array(8) as _}
				<div class="flex items-center px-2 py-3">
					...
					<!-- Source -->
					<div class="hidden w-48 items-center gap-2 sm:flex">
